...
# creatures. Each creature has two values: Attack and Health. Creatures 
# can fight each other, dealing their Attack damage, thereby reducing 
...
#                         unless the creature has been killed, its health 
#                         returns to the original value at the end of combat.
# - PermanentCardDamage : In other games (e.g., Hearthstone), health damage 
#                         persists.
# 
